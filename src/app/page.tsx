  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-200 flex flex-col">
      ...
      <main className="flex-1 pt-16">
        ...
        {/* Placeholder sections for build verification */}
        <section id="sobre-mi" className="py-24 px-6">
          <div className="max-w-[1280px] mx-auto text-center">
            <span className="text-xs uppercase tracking-[1.32px] text-zinc-500">Sobre mí</span>
          </div>
        </section>

        <section id="servicios" className="py-24 px-6 bg-[#18181b]">
          <div className="max-w-[1280px] mx-auto text-center">
            <span className="text-xs uppercase tracking-[1.32px] text-zinc-500">Servicios</span>
          </div>
        </section>

        <section id="proyectos" className="py-24 px-6">
          <div className="max-w-[1280px] mx-auto text-center">
            <span className="text-xs uppercase tracking-[1.32px] text-zinc-500">Proyectos</span>
          </div>
        </section>

        <section id="stack" className="py-24 px-6 bg-[#18181b]">
          <div className="max-w-[1280px] mx-auto text-center">
            <span className="text-xs uppercase tracking-[1.32px] text-zinc-500">Stack</span>
          </div>
        </section>

        <section id="contacto" className="py-24 px-6 bg-[#18181b]">
          <div className="max-w-[1280px] mx-auto text-center">
            <span className="text-xs uppercase tracking-[1.32px] text-zinc-500">Contacto</span>
          </div>
        </section>
      </main>
    </div>
